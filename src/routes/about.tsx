...
const EXPERIENCE = [
  {
    ...
    highlights: [
      "Maintained SLA targets across 200+ containerised services by implementing proactive monitoring with Prometheus and Grafana; configured alerts to detect and resolve issues before customer impact, achieving 99.9%+ uptime.",
      "Authored runbooks, incident response documentation, and system support procedures for all production services, enabling faster on-call resolution and knowledge transfer across teams.",
      "Led monolith-to-Kubernetes migration on AWS EKS — designed cluster topology, configured IRSA, HPA, and node auto-scaling — reducing deployment time by ~40% and supporting 69,000+ concurrent users.",
      "Drove end-to-end cloud migration from AWS to Azure using Azure Migrate; coordinated cross-functionally with development, QA, and infrastructure teams to ensure zero-downtime cutover with rollback strategy.",
      "Engineered hybrid on-prem cloud with Proxmox VE + TrueNAS (ZFS); automated backup and disaster recovery workflows via Terraform and Ansible, eliminating third-party cloud dependency.",
      "Performed root cause analysis on critical production incidents and resolved all issues within defined TAT; maintained zero escalation record across all client engagements.",
      "Enforced IAM least-privilege policies, VPC segmentation, SSL/TLS lifecycle management, and DevSecOps practices across all environments.",
      "Managed CI/CD pipeline automation using Jenkins and GitHub Actions; onboarded 200+ services onto DevOps toolchain, reducing manual deployment effort significantly.",
    ],
  },
  {
